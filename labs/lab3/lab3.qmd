...
<!-- TODO before submission: add Lab 3 hardware photo if desired. Confirm that the physical anode orientation places the newest digit on the required right-hand display. -->
...
This counter-based debounce is simple and deterministic. Its main tradeoff is a small fixed input delay; a sample-history debounce could respond sooner but would require additional state and logic.
...
Each scan tick stores the inverted synchronized columns into the correct four-bit portion of the 16-bit keypad map. The waveform builds `8000 -> 8400 -> 8420 -> 8421`, with `scan_done` asserted on the final row.
...
<!-- TODO before submission: add a legible synthesis/netlist screenshot explicitly showing no latches and no tristate buffers if required by the grader. -->

## Schematic

The Lab 3 hardware combines the keypad and dual-display circuits developed in Lab 2.

<!-- TODO before submission: add the final Lab 3 schematic with pin names/numbers, part numbers, component values, junctions, and title block. -->

## Block Diagrams

<!-- TODO before submission: add the required 1:1 block diagrams for the top-level and each new module. The Lab 3 specs place the full block-diagram requirements in effect. -->
...
**Hardware/documentation status:** TODO before submission: confirm physical display orientation and hardware checkoff, then add the final schematic, block diagrams, and synthesis screenshot before stating that every Lab 3 specification is complete.

## AI Prototype and Reflection

<!-- TODO: add the Lab 3 AI prototype prompt/output and a short reflection. Keep this concise. -->

## Time Spent

Total time spent on Lab 3: **TODO hours**
